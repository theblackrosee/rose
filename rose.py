...
def improve_dictionary(file_to_open):
    ...
    if leetmode == "y":
        for (
            ...
            unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in BruteList.cfg too...
...
def main():
    ...
    read_config(os.path.join(os.path.dirname(os.path.realpath(__file__)), "BruteList.cfg"))
